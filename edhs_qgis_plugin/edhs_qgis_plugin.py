...
class EdhsDialog(QDialog):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setWindowTitle("EDHS Hybrid Platform")
...
class EdhsQgisPlugin:
    ...
    def initGui(self) -> None:  # noqa: N802
        ...
        self._action = QAction("EDHS Hybrid Platform", self.iface.mainWindow())
        self._action.triggered.connect(self._show_dialog)
        self.iface.addPluginToMenu("&EDHS Hybrid Platform", self._action)
    ...
    def unload(self) -> None:
        ...
        if self._action is not None:
            self.iface.removePluginMenu("&EDHS Hybrid Platform", self._action)
